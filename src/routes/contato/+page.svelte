...
<section class="bg-gray-800 mt-28 text-white">
    <div class="flex flex-col md:px-6 py-10 mx-auto items-center justify-center">
        <h1 class="text-2xl font-semibold text-center capitalize md:text-3xl">Entre em contato.</h1>
        <h1 class="text-sm  mt-2 text-center ">
            Entre em contato. Responderemos
            o mais breve possível.
        </h1>
    </div>
    <div class="flex flex-col items-center justify-start mx-8 md:m-0 h-screen ">
        <form class=" p-8 border-2 rounded-xl text-gray-100 w-[320px] md:w-full md:mx-20 mt-14">
            <div class="">
                <div class="flex-1 mt-2 ">
                    <main class=" mb-2 text-sm">Nome completo</main>
                ...
                <div class="flex-1 mt-2">
                    <main class=" mb-2 text-sm  ">E-mail</main>
            ...
            <div class="w-full mt-4">
                <main class=" mb-2 text-sm  ">Mensagem</main>
